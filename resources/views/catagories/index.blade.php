                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                ...
                                @foreach($catagories as $key => $value)
                                   ...
                                   <li><h5> <a href="{{ URL::to('catagories/' . $value->id) }}">{{ $value->cTitle }}<br>
                                               <!--sidebar_dropdown-->
                                               <div class="actions">
                                                   <div class="btn-group ">
                        ...
                        <div class="portlet light">
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-helper">catagory:</span> &nbsp; <span class="caption-subject font-green-sharp bold uppercase">Tune Website</span>
                                </div>
                                <div class="actions">
                                    <div class="btn-group">
